...
const ACCOUNTS = [
  { id: '92e326e1-77a6-4426-95f6-505f0b36d852', sheet: 'BBVA PESOS', prefix: 'bb1a' },
  { id: 'b865af21-de39-4dbc-bf37-245c49a8ce50', sheet: 'BBVA DOLARES', prefix: 'bb2a' },
  { id: '3690f38f-6ea9-46de-b8cc-e183e0542ab5', sheet: 'MONEX USD', prefix: 'ba30' }
];
...
function getISO(s: any) {
    ...
    // Fix years that are obviously typos (2024, 2001) to 2025
    if (d.getFullYear() === 2024 || d.getFullYear() === 2001) {
        d.setFullYear(2025);
    }
